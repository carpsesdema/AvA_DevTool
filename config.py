...
if getattr(sys, 'frozen', False):
    ...
    # Running from source
    APP_BASE_DIR_RESOLVED = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
...
if getattr(sys, 'frozen', False):
    ...
    _DOTENV_BASE_DIR = os.path.dirname(os.path.abspath(__file__)) # Directory of config.py
    # If config.py is in a subdirectory of project root, adjust:
    # _DOTENV_BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) # Project root
